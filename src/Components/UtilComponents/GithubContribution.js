...
const token = process.env.NODE_ENV === 'development' ? "enter-token-here" : process.env.REACT_APP_GITHUB_ACCESS_TOKEN;
            ...
            <svg width="640" height="137">
                {
                    monthData.map((month, i) => (
                        <text
                            style={{fontFamily: 'Helvetica', fontSize: '0.7em'}}
                            x={ 13 + i * 640 / 12} 
                            y="20"
                ...
                <text 
                    style={{fontFamily: 'Helvetica', fontSize: '0.9em'}}
                    fill={colorsDark.plainFont}
                    x="15" 
                    y="134">Total contributions in {monthData[0].year}:
                </text>
                <text 
                    style={{fontFamily: 'Helvetica', fontSize: '1em', fontWeight: 'bold'}}
